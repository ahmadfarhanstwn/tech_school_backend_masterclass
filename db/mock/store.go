...
// Source: github.com/ahmadfarhanstwn/simple_bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTransaction(arg0 context.Context, arg1 db.TransferTransactionsParams) (db.TransferTransactionsResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTransaction", arg0, arg1)
	ret0, _ := ret[0].(db.TransferTransactionsResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
